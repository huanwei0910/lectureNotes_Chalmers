...
#include "myCylindricalInletVelocityFvPatchVectorField.H"
#include "volFields.H"
...
Foam::myCylindricalInletVelocityFvPatchVectorField::
...
myCylindricalInletVelocityFvPatchVectorField
(
    const myCylindricalInletVelocityFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::myCylindricalInletVelocityFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::myCylindricalInletVelocityFvPatchVectorField::write(Ostream& os) const
{
